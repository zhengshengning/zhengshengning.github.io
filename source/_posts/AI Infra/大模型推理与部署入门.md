...
- [2. KV Cache：推理的显存刺客](#2-kv-cache推理的显存刺客)
- [3. 推理引擎核心技术](#3-推理引擎核心技术)
- [4. 主流推理框架](#4-主流推理框架)
- [5. 量化技术](#5-量化技术)
- [6. Speculative Decoding](#6-speculative-decoding)
- [7. 系统架构：Prefill/Decode 解耦](#7-系统架构prefilldecode-解耦)
...
| 方向 | 内容 | 推荐资料 |
|------|------|---------|
| vLLM 源码 | PagedAttention / Scheduler / BlockManager | [vLLM - GitHub](https://github.com/vllm-project/vllm) |
| FlashAttention | Tiling + Online Softmax 的工程实现 | [FlashAttention - GitHub](https://github.com/Dao-AILab/flash-attention) |
| 系统架构 | Prefill/Decode 解耦的工程实践 | [DistServe Paper](https://arxiv.org/abs/2401.09670) |
| KV Cache 优化 | 量化、压缩、迁移 | [KIVI Paper](https://arxiv.org/abs/2402.02750) |
| 性能工程 | 建立完整的 Benchmark 回归体系 | [GenAI-Perf](https://docs.nvidia.com/deeplearning/triton-inference-server/user-guide/docs/client/src/c%2B%2B/perf_analyzer/genai-perf/README.html) |
