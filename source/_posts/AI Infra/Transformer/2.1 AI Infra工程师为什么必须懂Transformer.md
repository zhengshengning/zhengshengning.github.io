...
<img src="/images/理解AIInfra的职责边界.png" alt="理解AIInfra的职责边界" style="max-width: 100%; display: block; margin: 0 auto;" />
...
**GPT 系列（2018-2023）**：只使用 Decoder 部分，通过单向注意力（每个 token 只能看到前面的 token）和自回归预训练，在文本生成任务上不断突破。GPT-2 展示了大规模语言模型的文本生成能力，GPT-3 证明了 scaling law（更多参数 + 更多数据 = 更好的效果），GPT-4 则展示了大模型在多模态理解和复杂推理任务上的显著能力提升。
...
<img src="/images/AIInfra优化全流程解析.png" alt="AIInfra优化全流程解析" style="max-width: 100%; display: block; margin: 0 auto;" />
