---
title: 2.2 Transformer全貌及代码实现
date: 2026-03-31 15:30:00
categories:
  - [AI Infra, 前置知识, Transformer]
tags: [Transformer, 模型架构, Encoder-Decoder, Decoder-only, LLM, PyTorch, 代码实现]
mathjax: true
---
...
<img src="/images/Transformer.webp" alt="Transformer原始架构（Encoder-Decoder）" style="max-width: 90%; display: block; margin: 0 auto;" />
...
<img src="/images/encode-block.png" alt="Encoder Block" style="max-width: 60%; display: block; margin: 0 auto;" />
...
<img src="/images/decoder-block.png" alt="Decoder Block" style="max-width: 60%; display: block; margin: 0 auto;" />
