...
| 方向 | 说明 | 推荐资源 |
|------|------|---------|
| **复杂编排模式** | 学习条件分支、并行执行、动态智能体选择等高级编排策略 | Anthropic 官方多智能体设计文档 |
| **自定义技能开发** | 为智能体编写可复用的 Skill 插件，封装常见操作 | agent-caster 技能开发文档 |
| **跨平台适配** | 深入理解不同 AI Coding Agent 平台的差异与适配技巧 | opencode / Claude Code / Cursor 官方文档 |
| **评估与度量** | 建立多智能体系统的质量评估体系，量化衡量智能体协作效果 | LLM 评估相关论文与工具（如 LMSYS） |
| **安全与权限治理** | 设计更精细的权限模型，防止智能体越权操作 | OWASP LLM 安全指南 |
| **生产部署** | 将多智能体系统从本地开发部署到团队协作或 CI/CD 环境 | Docker + GitHub Actions 实践 |
